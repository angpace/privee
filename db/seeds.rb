...
#Events
angela27 = Event.create(title: "Angelas Bday Bash", amount_of_people: 10, user_id: sylvia.id, description: "I want to throw a party for my favorite daughter!")
kevin27 = Event.create(title: "Kevins Surprise Party", amount_of_people: 4, user_id: nori.id, description: "I love my dad and I am going to throw him a party.")
christmas = Event.create(title: "Jesus Born", amount_of_people: 13, user_id: nori.id, description: "Jesus has risen ya'lll!!!!")
newyears = Event.create(title: "New Year, New Us", amount_of_people: 30, user_id: sylvia.id, description: "2023!!!" )
